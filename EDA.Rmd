...
print("Skipping the description and the cast, since they have a lot of data in them")
...
probably just drop them if we are trying to use the ratings column in any 
modeling. 
