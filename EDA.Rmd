...
probably jsut drop them if we are trying to use the ratings column in any 
modeling. 
...
towards teenagers. I assume that TV-14 titles are targetted 
towards teenagers, rather than simply allowed for them to view and not 
recommended for under-14s. If teendagers are just allowed to view, but are not 
the expected demographic group, most of our data is targetted at adults.
We can combine this data with more detailed information about the categories of 
the titles (niche horror, cheerleader movies) to learn something about 
