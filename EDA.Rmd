...
which makes sense if they are paying the bills. 
```{r}
...
potentially don't. In this case it is interesting to note that we have
...
Notice that one title can have multiple associeated categories, so 
...
It is perhaps more illuminating to look at associated words,
